...
const s = StyleSheet.create({
  ...
  aramaWrap:        { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', marginHorizontal: 16, marginVertical: 12, borderRadius: 24, borderWidth: 1, borderColor: '#e5e7eb', paddingHorizontal: 16, paddingVertical: 11 },
  ...
  ilanlarGrid:      { paddingHorizontal: 16, flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 12 },
