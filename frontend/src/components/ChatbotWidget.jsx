...
export default function ChatbotWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Chat penceresi */}
      {acik && (
        <div className="w-[360px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-gray-700 flex flex-col overflow-hidden"
          style={{ height: '520px' }}>
          ...
          {mesajlar.length === 1 && !yukleniyor && (
            <div className="px-3 pb-2 flex flex-wrap gap-1.5 bg-slate-50 dark:bg-gray-950">
              {hizliSorular.map((s) => (
          ...
          {/* Input */}
          <div className="p-3 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 flex gap-2">
