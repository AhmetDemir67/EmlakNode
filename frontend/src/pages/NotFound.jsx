...
const NotFound = () => (
  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 text-center">
    ...
    <div className="bg-blue-600 text-white p-3 rounded-2xl mb-5 shadow-lg shadow-blue-900/40">
      <Home size={28} />
    </div>
    ...
    <div className="flex flex-col sm:flex-row gap-3">
      <Link
        to="/"
        className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-xl transition-colors shadow-md"
      >
        <Home size={16} />
        Ana Sayfaya Dön
      </Link>
