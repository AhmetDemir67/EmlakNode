  ...
  const HataEkrani = () => (
    <div className="flex flex-col items-center justify-center py-16">
      <div className="bg-red-50 border border-red-200 rounded-2xl p-6 max-w-md text-center">
        ...
        <button onClick={verileriGetir} className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-2.5 rounded-xl transition-colors mx-auto">
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="hidden sm:block text-orange-500 font-semibold text-sm hover:underline">Tümünü Gör →</button>
        </div>
